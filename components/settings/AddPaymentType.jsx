...
const AddPaymentType = () => {
  ...
  const submitHandler = (e) => {
    ...
    // Pour CASH, pas besoin de nom et numéro
    if (isCashPayment) {
      // Envoyer avec des valeurs par défaut pour CASH
      newPaymentType(platform, "Paiement en espèces", "CASH");
      return;
    }

    // Pour les autres plateformes, validation normale
      ...
      <div className="max-w-2xl mx-auto">
        <div className="mb-8">
          ...
          <p className="text-slate-600">
            Ajoutez une plateforme de paiement mobile ou le paiement en espèces
          </p>
        </div>
          ...
          <div className="p-8 space-y-6">
            ...
            <div className="group">
                ...
                {platforms.map((plat) => (
                  ...
                  >
                    <div className="flex items-center justify-center gap-2">
                      ...
                      {plat.value === "CASH" && (
                        <svg
                          className={`w-5 h-5 ${platform === plat.value ? "text-white" : ""}`}
                          fill="none"
                          stroke="currentColor"
                          viewBox="0 0 24 24"
                        >
              ...
              <p className="mt-2 text-sm text-slate-500">
                Sélectionnez la plateforme de paiement ou l'option espèces
              </p>
            </div>
                ...
                <div className="flex gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-green-700">
                      L'option de paiement en espèces permet aux clients de
                      payer lors de la récupération de leur commande. Aucune
                      information de compte n'est nécessaire.
                    </p>
                  </div>
                </div>
              </div>
            ...
            {/* Champs de formulaire - cachés pour CASH */}
            {!isCashPayment && (
              <>
                {/* Nom du titulaire */}
                <div className="group">
                ...
                {isCashPayment ? (
                  <div className="space-y-2">
                    ...
                    <p className="text-white/70 text-xs">
                      Les clients paieront lors de la récupération de leur
                      commande
                    </p>
                  </div>
                ) : (
